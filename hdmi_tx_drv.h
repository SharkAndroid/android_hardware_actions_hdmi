...
#define HDMI_GET_VIDEO_CONFIG _IOR(HDMI_TX_IOC_MAGIC, 0x93, u32)
/**
...
#define HDMI_SET_DICONNECT_FLAG _IOW(HDMI_TX_IOC_MAGIC, 0xAC, bool)

#define HDMI_SET_MUNUAL_FLAG _IOW(HDMI_TX_IOC_MAGIC, 0xAD, bool)

#define HDMI_SWITCH_SET_STATUS _IOW(HDMI_TX_IOC_MAGIC, 0xAE, u32)
#define HDMI_GET_DICONNECT_FLAG _IOR(HDMI_TX_IOC_MAGIC, 0xAF, u32)
#define HDMI_SET_HDCP_AUTHENTICATION _IOR(HDMI_TX_IOC_MAGIC, 0xB0, bool)
...
enum HDMI_MODE {
    HDMI_MODE_HDMI = 0, HDMI_MODE_DVI, HDMI_MODE_MAX
};

enum HDMI_PLUGGING {
    HDMI_PLUGOUT = 0, HDMI_PLUGIN, HDMI_PLUGGING_MAX
};
enum SRC_SEL {
    VITD = 0, DE, SRC_MAX
};
...
enum DEEP_COLOR {
    DEEP_COLOR_24_BIT = 0, DEEP_COLOR_30_BIT, DEEP_COLOR_36_BIT, DEEP_COLOR_MAX
};

enum COLOR_XVYCC {
    YCC601_YCC709 = 0, XVYCC601, XVYCC709, XVYCC_MAX
};

enum _3D_FORMAT {
    _3D_NOT = 0, _3D, _3D_FORMAT_MAX
};
